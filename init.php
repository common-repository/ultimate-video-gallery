...
<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="'.$width.'" height="'.$height.'" id="ultimatevideo'.$id.'-'.$contador.'" title="'.$title.'" align="middle">
...
function ultimate_add_menu(){	
	if (function_exists('add_options_page')) {
		//add_menu_page
		add_menu_page('ultimate', 'ULTIMATE VIDEO GALLERY', 8, 'ultimate', 'ultimate_panel');
	}
}
