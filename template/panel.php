...
jQuery('.<?php echo $id; ?>editbutton').click(function() {
	...
	return false;
	  ...
	  <legend><strong>ULTIMATE PRO <?php echo $id; ?>. Write in your Pages or Posts: [ultimate <?php echo $id; ?> /] or widget</strong><button class="editultimate<?php echo $id; ?>">EDIT</button></legend> 
